...
/*
	...
	static void nodeBuild(std::shared_ptr<MatArchNode> cnode, std::map<std::shared_ptr<MatArchNode>,std::shared_ptr<MatArchNodeView>>& nodes, std::vector<std::shared_ptr<MatArchNode>>& nodeList);
	static void linkBuild(std::shared_ptr<MatArchNode> cnode,  std::map<std::shared_ptr<MatArchNode>,std::shared_ptr<MatArchNodeView>>& nodes);
	//static void nodeClean(std::shared_ptr<MatArchNode> cnode, std::map<std::shared_ptr<MatArchNode>,std::shared_ptr<MatArchNodeView>>& nodeList);
